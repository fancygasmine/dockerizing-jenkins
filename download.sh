...
docker pull jenkins/jenkins:2.141
...
#    curl -o downloads/jdk-8u131-linux-x64.tar.gz http://ftp.osuosl.org/pub/funtoo/distfiles/oracle-java/jdk-8u131-linux-x64.tar.gz
    curl -o downloads/apache-maven-3.0.5-bin.tar.gz http://apache.mirror.anlx.net/maven/maven-3/3.0.5/binaries/apache-maven-3.0.5-bin.tar.gz
fi
